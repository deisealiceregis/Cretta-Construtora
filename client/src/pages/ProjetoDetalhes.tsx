...
export default function ProjetoDetalhes() {
  const [route, params] = useRoute('/projetos/:id');
  ...
  const query = trpc.projetos.getById.useQuery(
    { id: id || 0 },
    { enabled: !!id }
  );
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-primary text-white py-12 px-4">
        <div className="container">
          ...
          <p className="text-lg text-gray-200">{projeto.descricao}</p>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{projeto.localizacao}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{projeto.pavimentos || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{projeto.apartamentos || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{projeto.area ? `${projeto.area} m²` : 'N/A'}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xl font-bold text-primary">{projeto.progresso}%</span>
                  </div>
                </div>
              </div>
            </div>
